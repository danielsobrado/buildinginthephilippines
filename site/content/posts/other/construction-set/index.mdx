...
Building a house in the Philippines takes thorough planning, especially when working with architects. The right professional help makes a big difference in turning your dream home into reality.

The search for an architect doesn't need to be complicated. Social media groups offer many options:

* Facebook groups like ["Architects Philippines"](https://www.facebook.com/groups/1576568269174959) list professionals with rates from 10% of total construction cost (Holy Molly!).
* Some architects charge 400-500 PHP per square meter (2024 prices)
* Lower rates exist but check credentials thoroughly
* Reddit's [phinvest community](https://www.reddit.com/r/phinvest/comments/1ct1ix8/architect_fees/) shares experiences and recommendations
...
- **Structural Details**
  ...
  **Note**: If you have more than 2 stories, or roof deck, you might need a [soil test](https://www.buildinginthephilippines.com/soil-testing-and-foundation-considerations-for-coastal-limestone-areas-in-the-philippines/), prepare it in advance.
...
If you have CAD plans, you might be able to visualize them in [Virtual Reality](https://www.buildinginthephilippines.com/the-game-changer-in-architectural-visualization/).
