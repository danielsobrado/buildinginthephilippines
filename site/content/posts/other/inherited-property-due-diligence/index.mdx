...
But then I did more research and found Pedrosa v. CA (2001). This Supreme Court case basically said: the two-year protection only applies to heirs who had notice or participated. If an heir was truly omitted - never knew about it, never participated - they might NOT be bound by the two-year limit.
...
Buying inherited property in the Philippines can be fine. Most transactions go through without problems. But the ones that go wrong can be catastrophic - you lose the property AND the money.
...
And if something feels off - if sellers are rushing you, if family members are evasive, if the story keeps changing - walk away. There's always another property.
