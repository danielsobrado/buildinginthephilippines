---
title: 'DIY Indoor Hydroponics Part 2: Starting Simple Before I Automate It'
...
In [Part 1](/diy-indoor-hydroponics-part-1-starting-bibb-lettuce-from-seed), I started the first Bibb lettuce seeds. This article steps back and explains the minimum system I am building around them.
...
![Complete V1 indoor hydroponics architecture with a 3 × 3 grow tent, Tapo-controlled 240 W LED grow light, 140 mm circulation fan, four 3D-printed net pots, 30 L reservoir, two air stones and a SOBO air pump](./complete-v1-architecture.jpg)
