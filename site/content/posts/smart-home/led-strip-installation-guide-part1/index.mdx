...
![UK plug with cable to be cut](Cables1.jpg)
...
![UK plug with exposed wires ready for connection, three-core cable showing brown (live), blue (neutral), and green-yellow (earth) wires](Cables2.jpg)
