...
tags: ['#aluminum-windows', '#chinese-suppliers', '#typhoon', '#coastal-building', '#China']
date: 2025-08-29
thumbnail: image.jpg
featured: true
---
...
## Case Study: Odette Survivors vs Casualties

**Project A: Cebu Coastal Villa (DERCHI Windows)**
- Hurricane-certified triple tempered glass
- Category 5 wind testing verified
- **Typhoon Odette result:** Zero failures, minor adjustment needed

**Project B: Bohol Resort (Local Fabrication)**
- Standard double glass, 1.2mm profiles
- No typhoon certification
- **Typhoon Odette result:** Extensive window failures, complete replacement required

**Project C: Siargao Development (Mid-tier Chinese)**
- WANJIA standard line, upgraded hardware
- AS2047 equivalent specifications
- **Typhoon Odette result:** Minor failures, primarily installation-related issues
...
### Choose Philippine Fabrication When:
- Temporary or low-value structures
- Immediate availability required
- Budget extremely constrained
- Replacement in 5-7 years acceptable

### Never Choose Local Fabrication When:
- Coastal exposure (guaranteed failure)
- High-value property investment
- Typhoon zone construction
