...
description: "How to inspect rebar stirrups in Philippine concrete footings. Spacing, tie wire, hooks and common cheats contractors use to save money."
category: Structures
...
## What to check (Size & Spacing)

### 1. Is the bar big enough?
